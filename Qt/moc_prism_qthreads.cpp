...
void ProbeThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->signalProbe_diffK((*reinterpret_cast< Prismatic::Array2D<PRISMATIC_FLOAT_PRECISION>(*)>(_a[1]))); break;
        case 5: _t->signalProbe_diffR((*reinterpret_cast< Prismatic::Array2D<PRISMATIC_FLOAT_PRECISION>(*)>(_a[1]))); break;
...
// SIGNAL 4
void ProbeThread::signalProbe_diffK(Prismatic::Array2D<PRISMATIC_FLOAT_PRECISION> _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 5
void ProbeThread::signalProbe_diffR(Prismatic::Array2D<PRISMATIC_FLOAT_PRECISION> _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
