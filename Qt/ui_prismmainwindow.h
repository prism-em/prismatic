...
public:
    ...
    void setupUi(QMainWindow *PRISMMainWindow)
    {
        ...
        PRISMMainWindow->resize(1336, 1218);
        PRISMMainWindow->setMaximumSize(QSize(1536, 1536));
        ...
        verticalLayout_17->addWidget(slider_bothSlices);
        ...
        verticalLayout_17->addWidget(checkBox_sqrtIntensityPot);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 326, 1136));
        ...
        sizePolicy8.setHeightForWidth(lineEdit_probeStepX->sizePolicy().hasHeightForWidth());
        lineEdit_probeStepX->setSizePolicy(sizePolicy8);
        ...
        QWidget::setTabOrder(btn_go, checkBox_sqrtIntensityPot);
        QWidget::setTabOrder(checkBox_sqrtIntensityPot, lineEdit_contrastPotMax);
        ...
        QWidget::setTabOrder(lineEdit_detectorAngle, lineEdit_outputfile);
        ...
        QWidget::setTabOrder(checkBox_4D, spinBox_numThreads);
