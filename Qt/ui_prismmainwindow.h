...
public:
    ...
    void setupUi(QMainWindow *PRISMMainWindow)
    {
        ...
        PRISMMainWindow->resize(956, 1089);
        ...
        contrast_outputMin->setMaximumSize(QSize(75, 16777215));
        contrast_outputMin->setMaxLength(16);
        ...
        contrast_outputMax->setMaximumSize(QSize(75, 16777215));
        contrast_outputMax->setMaxLength(16);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 320, 1035));
        ...
        sizePolicy6.setHeightForWidth(lineedit_pixelSize->sizePolicy().hasHeightForWidth());
        lineedit_pixelSize->setSizePolicy(sizePolicy6);
        lineedit_pixelSize->setMinimumSize(QSize(40, 20));
        lineedit_pixelSize->setMaximumSize(QSize(30, 20));
        ...
        sizePolicy6.setHeightForWidth(lineEdit_E0->sizePolicy().hasHeightForWidth());
        lineEdit_E0->setSizePolicy(sizePolicy6);
        ...
        sizePolicy6.setHeightForWidth(lineEdit_potbound->sizePolicy().hasHeightForWidth());
        lineEdit_potbound->setSizePolicy(sizePolicy6);
        ...
        sizePolicy6.setHeightForWidth(lineEdit_probeSemiangle->sizePolicy().hasHeightForWidth());
        lineEdit_probeSemiangle->setSizePolicy(sizePolicy6);
        ...
        sizePolicy7.setHeightForWidth(lineEdit_probeDefocus->sizePolicy().hasHeightForWidth());
        lineEdit_probeDefocus->setSizePolicy(sizePolicy7);
        ...
        sizePolicy7.setHeightForWidth(lineEdit_C3->sizePolicy().hasHeightForWidth());
        lineEdit_C3->setSizePolicy(sizePolicy7);
        ...
        sizePolicy7.setHeightForWidth(lineEdit_C5->sizePolicy().hasHeightForWidth());
        lineEdit_C5->setSizePolicy(sizePolicy7);
        ...
        lineEdit_randomSeed->setMaximumSize(QSize(40, 16777215));
        ...
        sizePolicy6.setHeightForWidth(spinBox_numFP->sizePolicy().hasHeightForWidth());
        spinBox_numFP->setSizePolicy(sizePolicy6);
        ...
        sizePolicy2.setHeightForWidth(lbl_sliceThickness->sizePolicy().hasHeightForWidth());
        lbl_sliceThickness->setSizePolicy(sizePolicy2);
        ...
        sizePolicy6.setHeightForWidth(lineEdit_sliceThickness->sizePolicy().hasHeightForWidth());
        lineEdit_sliceThickness->setSizePolicy(sizePolicy6);
        ...
        sizePolicy7.setHeightForWidth(lineEdit_detectorAngle->sizePolicy().hasHeightForWidth());
        lineEdit_detectorAngle->setSizePolicy(sizePolicy7);
        ...
        sizePolicy6.setHeightForWidth(lineEdit_probeStepX->sizePolicy().hasHeightForWidth());
        lineEdit_probeStepX->setSizePolicy(sizePolicy6);
        ...
        horizontalLayout_44->addWidget(checkBox_streamdata);
        ...
        horizontalLayout_44->addWidget(checkBox_thermalEffects);
