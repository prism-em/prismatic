...
public:
    ...
    QLabel *label_27;
    QLineEdit *contrast_outputMin;
    QLineEdit *contrast_outputMax;
    ...
    void setupUi(QMainWindow *PRISMMainWindow)
    {
        ...
        PRISMMainWindow->resize(1000, 933);
        ...
        sizePolicy.setHeightForWidth(lbl_image_probeInteractive->sizePolicy().hasHeightForWidth());
        lbl_image_probeInteractive->setSizePolicy(sizePolicy);
        ...
        verticalLayout_22->addWidget(lbl_image_probeInteractive);
        ...
        sizePolicy2.setHeightForWidth(lbl_image_probe_mr->sizePolicy().hasHeightForWidth());
        lbl_image_probe_mr->setSizePolicy(sizePolicy2);
        lbl_image_probe_mr->setMinimumSize(QSize(150, 150));
        lbl_image_probe_mr->setAlignment(Qt::AlignCenter);

        verticalLayout_19->addWidget(lbl_image_probe_mr);

        lbl_image_probe_pr = new QLabel(tab_probe);
        lbl_image_probe_pr->setObjectName(QStringLiteral("lbl_image_probe_pr"));
        sizePolicy2.setHeightForWidth(lbl_image_probe_pr->sizePolicy().hasHeightForWidth());
        lbl_image_probe_pr->setSizePolicy(sizePolicy2);
        ...
        sizePolicy2.setHeightForWidth(lbl_image_probe_mk->sizePolicy().hasHeightForWidth());
        lbl_image_probe_mk->setSizePolicy(sizePolicy2);
        ...
        sizePolicy2.setHeightForWidth(lbl_image_probe_pk->sizePolicy().hasHeightForWidth());
        lbl_image_probe_pk->setSizePolicy(sizePolicy2);
        lbl_image_probe_pk->setMinimumSize(QSize(150, 150));
        lbl_image_probe_pk->setAlignment(Qt::AlignCenter);

        verticalLayout_20->addWidget(lbl_image_probe_pk);
        ...
        sizePolicy.setHeightForWidth(lbl_image_output->sizePolicy().hasHeightForWidth());
        lbl_image_output->setSizePolicy(sizePolicy);
        ...
        contrast_outputMin = new QLineEdit(tab_output);
        contrast_outputMin->setObjectName(QStringLiteral("contrast_outputMin"));
        contrast_outputMin->setEnabled(false);
        contrast_outputMin->setMaximumSize(QSize(60, 16777215));
        contrast_outputMin->setMaxLength(6);

        verticalLayout_25->addWidget(contrast_outputMin);

        contrast_outputMax = new QLineEdit(tab_output);
        contrast_outputMax->setObjectName(QStringLiteral("contrast_outputMax"));
        contrast_outputMax->setEnabled(false);
        contrast_outputMax->setMaximumSize(QSize(60, 16777215));
        contrast_outputMax->setMaxLength(6);

        verticalLayout_25->addWidget(contrast_outputMax);
        ...
        sizePolicy3.setHeightForWidth(box_sampleSettings->sizePolicy().hasHeightForWidth());
        box_sampleSettings->setSizePolicy(sizePolicy3);
        box_sampleSettings->setMaximumSize(QSize(510, 16777215));
        ...
        sizePolicy4.setHeightForWidth(btn_saveCoordinates->sizePolicy().hasHeightForWidth());
        btn_saveCoordinates->setSizePolicy(sizePolicy4);
        ...
        sizePolicy4.setHeightForWidth(lineEdit_cellDimX->sizePolicy().hasHeightForWidth());
        lineEdit_cellDimX->setSizePolicy(sizePolicy4);
        ...
        sizePolicy4.setHeightForWidth(lineEdit_cellDimY->sizePolicy().hasHeightForWidth());
        lineEdit_cellDimY->setSizePolicy(sizePolicy4);
        ...
        sizePolicy4.setHeightForWidth(lineEdit_cellDimZ->sizePolicy().hasHeightForWidth());
        lineEdit_cellDimZ->setSizePolicy(sizePolicy4);
        ...
        sizePolicy3.setHeightForWidth(box_simulationSettings->sizePolicy().hasHeightForWidth());
        box_simulationSettings->setSizePolicy(sizePolicy3);
        ...
        sizePolicy5.setHeightForWidth(lbl_pixelSize->sizePolicy().hasHeightForWidth());
        lbl_pixelSize->setSizePolicy(sizePolicy5);
        ...
        sizePolicy2.setHeightForWidth(lineedit_pixelSize->sizePolicy().hasHeightForWidth());
        lineedit_pixelSize->setSizePolicy(sizePolicy2);
        ...
        sizePolicy5.setHeightForWidth(lbl_E0->sizePolicy().hasHeightForWidth());
        lbl_E0->setSizePolicy(sizePolicy5);
        ...
        sizePolicy2.setHeightForWidth(lineEdit_E0->sizePolicy().hasHeightForWidth());
        lineEdit_E0->setSizePolicy(sizePolicy2);
        ...
        sizePolicy5.setHeightForWidth(lbl_potBound->sizePolicy().hasHeightForWidth());
        lbl_potBound->setSizePolicy(sizePolicy5);
        ...
        sizePolicy2.setHeightForWidth(lineEdit_potbound->sizePolicy().hasHeightForWidth());
        lineEdit_potbound->setSizePolicy(sizePolicy2);
        ...
        sizePolicy5.setHeightForWidth(label_alphaBeamMax->sizePolicy().hasHeightForWidth());
        label_alphaBeamMax->setSizePolicy(sizePolicy5);
        ...
        sizePolicy2.setHeightForWidth(lineEdit_alphaBeamMax->sizePolicy().hasHeightForWidth());
        lineEdit_alphaBeamMax->setSizePolicy(sizePolicy2);
        lineEdit_alphaBeamMax->setMaximumSize(QSize(40, 16777215));
        ...
        sizePolicy5.setHeightForWidth(lbl_lambda->sizePolicy().hasHeightForWidth());
        lbl_lambda->setSizePolicy(sizePolicy5);
        ...
        sizePolicy5.setHeightForWidth(lbl_alphaMax->sizePolicy().hasHeightForWidth());
        lbl_alphaMax->setSizePolicy(sizePolicy5);
        ...
        sizePolicy5.setHeightForWidth(lbl_numfp->sizePolicy().hasHeightForWidth());
        lbl_numfp->setSizePolicy(sizePolicy5);
        ...
        sizePolicy2.setHeightForWidth(spinBox_numFP->sizePolicy().hasHeightForWidth());
        spinBox_numFP->setSizePolicy(sizePolicy2);
        ...
        horizontalLayout_34->addWidget(lbl_probeStep);

        lineEdit_probeStep = new QLineEdit(box_simulationSettings);
        lineEdit_probeStep->setObjectName(QStringLiteral("lineEdit_probeStep"));
        sizePolicy2.setHeightForWidth(lineEdit_probeStep->sizePolicy().hasHeightForWidth());
        lineEdit_probeStep->setSizePolicy(sizePolicy2);
        lineEdit_probeStep->setMaximumSize(QSize(40, 16777215));

        horizontalLayout_34->addWidget(lineEdit_probeStep);
        ...
        sizePolicy2.setHeightForWidth(lineEdit_sliceThickness->sizePolicy().hasHeightForWidth());
        lineEdit_sliceThickness->setSizePolicy(sizePolicy2);
        ...
        sizePolicy3.setHeightForWidth(box_calculationSettings->sizePolicy().hasHeightForWidth());
        box_calculationSettings->setSizePolicy(sizePolicy3);
        ...
        radioButton_3Doutput->setChecked(true);
        radioButton_3Doutput->setAutoExclusive(false);
        ...
        lineEdit_3Doutputang->setEnabled(false);
        ...
        checkBox_streamdata = new QCheckBox(box_calculationSettings);
        checkBox_streamdata->setObjectName(QStringLiteral("checkBox_streamdata"));
        checkBox_streamdata->setEnabled(true);
        checkBox_streamdata->setAutoFillBackground(false);
        checkBox_streamdata->setTristate(false);

        verticalLayout_14->addWidget(checkBox_streamdata);
...
"Step (A)", Q_NULLPTR));
        lineEdit_probeStep->setText(QApplication::translate("PRISMMainWindow", "0.25", Q_NULLPTR));
...
"Thickness (A)", Q_NULLPTR));
        ...
        checkBox_streamdata->setText(QApplication::translate("PRISMMainWindow", "Streaming Mode", Q_NULLPTR));
