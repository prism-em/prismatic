...
namespace PRISM {
    ...
    void PRISM03(emdSTEM<T> &pars) {
        ...
        cout << "pars.stack.get_diml() = " << pars.stack.get_diml() << endl;
...
//        for (auto &i:pars.xyBeams) cout << i << endl;
//        for (auto &i : beamsReduce)cout << i << endl;
//        cout << "pars.qxaReduce" << endl;
//        for (auto &i : pars.qxaReduce)cout << i << endl;
//        cout << "pars.qyaReduce" << endl;
//        for (auto &i : pars.qyaReduce)cout << i << endl;
